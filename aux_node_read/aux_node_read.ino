/* Note: The Third message from sender is very important its 2nd and 3rd bit is acting as a key for ignition,so while uploading it into Lab car 
 *  make sure you make thes bit to 11 else you wont be able to control any aux load */
...
//udp(sw8, sw9, sw2, 1, 7, 8);
// udp function is used for implementing the working of upper dipper and passlight
